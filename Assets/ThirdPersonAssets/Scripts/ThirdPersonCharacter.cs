...
namespace UnityStandardAssets.Characters.ThirdPerson
{
	...
	public class ThirdPersonCharacter : MonoBehaviour
	{
        ...
        public delegate void OnJumpComprobation();

        private OnJumpComprobation ojc;
		...
		void CheckGroundStatus()
		{
			...
			if (Physics.Raycast(transform.position + (Vector3.up * 0.1f), Vector3.down, out hitInfo, m_GroundCheckDistance, LayerMask.GetMask("Ground"))) //HEMOS AÑADIDO "LayerMask.GetMask("Ground")"
            {
